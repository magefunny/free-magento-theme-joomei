...
namespace ThemeFunny\PopupContent\Helper;
...
{
    const XML_PATH_CONFIG_POPUP = 'popup_content/';
    ...
    public function __construct(
        ...
        \ThemeFunny\Core\Helper\Data $helperCore
    )
    {
    ...
    {
        $template      = 'ThemeFunny_PopupContent::popup-content.phtml';
        $isHomePage    = $this->helperCore->isHomePage();
